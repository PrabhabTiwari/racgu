...
export const INITIAL_MEMBERS: UserProfile[] = [
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    role: 'member',
    roleTitle: 'Collegiate Member',
    avatar: 'https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?auto=format&fit=crop&q=80&w=800',
