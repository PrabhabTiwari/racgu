...
$members = [
    ['Rtr. Prabhab Tiwari', 't.prabhab@gmail.com', 'pst', 'Charter President', '/members/prabhab.webp', '9748421238', 'A+ve'],
    ['Rtr. Sujan Shrestha', 'itssujanshrestha@gmail.com', 'pst', 'Secretary', '/members/sujan-shrestha.webp', '9805229925', 'O+ve'],
    ['Rtr. Madhab Khanal', 'madhabkhanal63@gmail.com', 'pst', 'Treasurer', '/members/madhab.webp', '9769490997', 'O+ve'],
    ['Rtr. Shreya Subedi', 'shreyasubedi96@gmail.com', 'member', 'Joint-Secretary', '/members/shreya.webp', '9768059752', 'B+ve'],
    ['Rtr. Rajiv Rimal', 'rimalrajeev@gmail.com', 'member', 'Joint-Treasurer/SAA', '/members/rajiv.webp', '9769490279', 'O+ve'],
    ['Rtr. Raj Dhakal', 'dhakalrd001@gmail.com', 'member', 'Editor/PRO', '/members/raj.webp', '9765659748', 'AB+ve'],
    ['Rtr. Manila Adhikari', 'maniladhkr@gmail.com', 'member', 'Club Administration Chair', '/members/manila.webp', '9748219643', 'O+ve'],
    ['Rtr. Sandhya Sharma', 'sandhya20630429@gmail.com', 'member', 'Service Area Project', '/members/sandhya.webp', '9765363760', 'B+ve'],
    ['Rtr. Rakhi Bhujel', 'rakhibhujel6@gmail.com', 'member', 'Service Project Chair', '/members/rakhi.webp', '9819194801', 'O+ve'],
    ['Rtr. Sanjana Adhikari', 'sanjanaadk321@gmail.com', 'member', 'Event Management Chair', '/members/sanjana.webp', '9827138523', 'A+ve'],
    ['Rtr. Sujan Giri', 'girisujan2064@gmail.com', 'member', 'Sports Co-ordinator', '/members/sujan-giri.webp', '9828370013', 'O+ve'],
    ['Rtr. Arpan Bhandari', 'arpanbhandari195@gmail.com', 'member', 'International Service Chair', '/members/arpan.webp', '9741789915', 'A+ve'],
    ['Rtr. Sandesh Dhakal', 'dhakalsandesh695@gmail.com', 'member', 'Collegiate Member', '/members/sandesh.webp', '9819174322', 'B+ve'],
    ['Rtr. Pratigya BK', 'pratigya.bk@student.gandaki.edu.np', 'member', 'Collegiate Member', '/members/pratigya.webp', '9846111002', 'A+ve'],
    ['Rtr. Punam Pun Magar', 'suzainpun@gmail.com', 'member', 'Collegiate Member', '/members/punam.webp', '9820632128', 'A+ve'],
    ['Rtr. Salina Bastola', 'salinabanstola937@gmail.com', 'member', 'Collegiate Member', '/members/salina.webp', '9766010091', 'B+ve'],
    ['Rtr. Sangam Bhujel', 'sangam.bhujel@student.gandaki.edu.np', 'member', 'Collegiate Member', '/members/sangam.webp', '9846111005', 'O+ve'],
    ['Rtr. Subarna Poudel', 'poudelsubarna61@gmail.com', 'member', 'Collegiate Member', '/members/subarna.webp', '9824146744', 'B+ve'],
    ['Rtr. Akriti Bhattarai', 'akriti13pokhara@gmail.com', 'member', 'Collegiate Member', '/members/akriti.webp', '9765632421', 'A+ve'],
    ['Rtr. Suresh Gurung', 'suresh.gurung@student.gandaki.edu.np', 'member', 'Collegiate Member', '/members/suresh.webp', '9846111008', 'AB+ve'],
    ['Rtr. Manoram Subedi', 'manoram.subedi@student.gandaki.edu.np', 'member', 'Collegiate Member', '/members/manoram.webp', '9846111009', 'O-ve'],
    ['Rtr. Diperson BK', 'dipersonb.k@gmail.com', 'member', 'Collegiate Member', '/members/diperson.webp', '9801599537', 'A+ve'],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $find = $pdo->prepare('SELECT id FROM users WHERE LOWER(JSON_UNQUOTE(JSON_EXTRACT(profile_json, "$.name"))) = ? LIMIT 1');
        ...
        foreach ($members as $index => [$name, $email, $role, $title, $avatar, $phone, $bloodGroup]) {
